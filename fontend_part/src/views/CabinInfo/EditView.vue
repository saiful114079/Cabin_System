                ...
                <div class="card custom__card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-4 m-auto">
                            <form @submit.prevent="updateCabinInfo" ref="storeCabinInfo">
                            <div class="mb-3">
...
export default {
  ...
  // Data Bingding
    ...
    created(){
        ...
        axios.get('http://127.0.0.1:8000/api/cabin/'+id)
    ...
    methods:{
        ...
        updateCabinInfo(){
            let id = this.$route.params.id
            axios.patch('http://127.0.0.1:8000/api/cabin/'+ id, this.form)
            .then(() =>{
                this.$router.push({ name: 'cabin-list' })
                // alert =========
